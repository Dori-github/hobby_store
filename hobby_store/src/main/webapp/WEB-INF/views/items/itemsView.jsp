...
<div class="course-info">
	...
	<div class="left-img">
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
		  ...
		  <div class="carousel-inner">
	     	<div class="carousel-item active">
		      <img src="imageView.do?items_num=${items.items_num}&items_type=1" class="d-block w-100">
		    </div>
	        <c:if test="${!empty items.items_photo_name2}">
		    <div class="carousel-item">
		      <img src="imageView.do?items_num=${items.items_num}&items_type=2" class="d-block w-100">
		    </div>
		    </c:if>
		    <c:if test="${!empty items.items_photo_name3}">
		    <div class="carousel-item">
		      <img src="imageView.do?items_num=${items.items_num}&items_type=3" class="d-block w-100">
		    </div>
		    </c:if>
		  </div>
		...
		<ul>
			<li>
				<label for="img1"><img src="imageView.do?items_num=${items.items_num}&items_type=1" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></label>
			</li>
			<c:if test="${!empty items.items_photo_name2}">
			<li>
				<label for="img2"><img src="imageView.do?items_num=${items.items_num}&items_type=2"></label>
			</li>
			</c:if>
			<c:if test="${!empty items.items_photo_name3}">
			<li>
				<label for="img3"><img src="imageView.do?items_num=${items.items_num}&items_type=3"></label>
			</li>
			</c:if>
		</ul>
	</div>
	...
	<div class="right-class">
		<p>
			${items.mem_nickname} 
			<span class="heart" data-num="${items.items_num}"><i class="fa-regular fa-heart" style="color:red;"></i> 찜하기 <span class = "heart-count" id = "heart-count"></</span></span>

		</p>
		<p>
		</p>
		<p>
			<h3><b>${items.items_name}</b></h3>
		</p>
		<div>
			<c:if test="${!empty items.items_zipcode}">
			<p>
				<span class="gray"><i class="fa-solid fa-location-dot"></i> &nbsp;${items.items_address1} ${items.items_address2}</span>
			</p>
			</c:if>
			<p>
...
<div class="course-d-info">
	...
	<fieldset>
		...
		<input type="radio" name="star_auth" value="3" id="rate3"><label
			for="rate3">★</label>
		<input type="radio" name="star_auth" value="2" id="rate4"><label
			for="rate4">★</label>
