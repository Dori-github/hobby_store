...
<form:form action="/space/admin_write.do" id="space_form" modelAttribute="spaceVO" enctype="multipart/form-data">
	<div class="title">공간 등록</div>
	<table class="reg-form">
		...
		<tr>
			...
			<td>
				...
				<div class="list-box">
			        <ul class="list-cate">
			            <li data-value="">카테고리</li>
			            <li data-value="1">촬영 스튜디오</li>
			            <li data-value="2">댄스공간</li>
			            <li data-value="3">체육시설</li>
			            <li data-value="4">악기 연습실</li>
			            <li data-value="5">공연장</li>
		...
		<tr id="datetime" style="display:none;">
			...
			<td>
				...
				<table>
					<tr>
						<th>
							<input type="checkbox" name="spaceTimeVO[0].space_reg_date" id="mon" value="월"/>
							<label for="mon"><i class="fa-solid fa-check"></i> 월</label>
						</th>
						<td>
							<input type="text" name="spaceTimeVO[0].space_reg_times" class="time-choice time1" placeholder="시간 선택" autocomplete="off">
							<span>추가</span>
						</td>					
					</tr>
					<tr>
						<th>
							<input type="checkbox" name="spaceTimeVO[1].space_reg_date" data-num="2" id="tues" value="화"/>
							<label for="tues"><i class="fa-solid fa-check"></i> 화</label>
						</th>
						<td>
							<input type="text" name="spaceTimeVO[1].space_reg_times" class="time-choice time2" placeholder="시간 선택">
							<span>추가</span>
						</td>					
					</tr>
					<tr>
						<th>
							<input type="checkbox" name="spaceTimeVO[2].space_reg_date" id="wed" value="수"/>
							<label for="wed"><i class="fa-solid fa-check"></i> 수</label>
						</th>
						<td>
							<input type="text" name="spaceTimeVO[2].space_reg_times" class="time-choice time3"  placeholder="시간 선택">
							<span>추가</span>
						</td>					
					</tr>
					<tr>
						<th>
							<input type="checkbox" name="spaceTimeVO[3].space_reg_date" id="thur" value="목"/>
							<label for="thur"><i class="fa-solid fa-check"></i> 목</label>
						</th>
						<td>
							<input type="text" name="spaceTimeVO[3].space_reg_times" class="time-choice time4" placeholder="시간 선택">
							<span>추가</span>
						</td>					
					</tr>
					<tr>
						<th>
							<input type="checkbox" name="spaceTimeVO[4].space_reg_date" id="fri" value="금"/>
							<label for="fri"><i class="fa-solid fa-check"></i> 금</label>
						</th>
						<td>
							<input type="text" name="spaceTimeVO[4].space_reg_times" class="time-choice time5" placeholder="시간 선택">
							<span>추가</span>
						</td>					
					</tr>
					<tr>
						<th>
							<input type="checkbox" name="spaceTimeVO[5].space_reg_date" id="sat" value="토"/>
							<label for="sat"><i class="fa-solid fa-check"></i> 토</label>
						</th>
						<td>
							<input type="text" name="spaceTimeVO[5].space_reg_times" class="time-choice time6" placeholder="시간 선택">
							<span>추가</span>
						</td>					
					</tr>
					<tr>
						<th>
							<input type="checkbox" name="spaceTimeVO[6].space_reg_date" id="sun" value="일"/>
							<label for="sun"><i class="fa-solid fa-check"></i> 일</label>
						</th>
						<td>
							<input type="text" name="spaceTimeVO[6].space_reg_times" class="time-choice time7 t1" placeholder="시간 선택">
							<span>추가</span>
						</td>					
					</tr>
				</table>
			</td>
			<form:errors element="div" path="space_reg_date" cssClass="error-color"/>
			<form:errors element="div" path="space_reg_time" cssClass="error-color"/>
		</tr>
		...
		<tr class="monthCount" style="display:none;">
			...
			<td>
				<div>
				<input type="number" id="space_month" name="space_month" value="${fn:replace(spaceVO.space_month,'0','')}"> 개월 
				<input type="number" id="space_count" name="space_count" value="${fn:replace(spaceVO.space_count,'0','')}"/> 회</div>
				<form:errors element="div" path="space_month" cssClass="error-color"/>
				<form:errors element="div" path="space_count" cssClass="error-color"/>
			</td>
		</tr>
		...
		<tr class="limit" style="display:none;">
			...
			<td>
				<ul>
					...
					<li><form:input type="number" path="space_limit" value="1"/></li>
					<li id="plus"><i class="fa-solid fa-plus" style="line-height:30px;"></i></li>
				</ul>
				<form:errors element="div" path="space_limit" cssClass="error-color"/>
			</td>
		</tr>
		<tr class="np" style="display:none;">
			...
			<td>
				<ul>
					<li id="minus"><i class="fa-solid fa-minus" style="line-height:30px;"></i></li>
					<li><form:input type="number" path="space_np" value="1"/></li>
					<li id="plus"><i class="fa-solid fa-plus" style="line-height:30px;"></i></li>
				</ul>
				<form:errors element="div" path="space_np" cssClass="error-color"/>
			</td>
		</tr>
		<tr id="price">
			<td>가격</td>
		...
		<tr class="address1" style="display:none;">
			...
			<td>
				...
				<form:errors element="div" path="space_address1" cssClass="error-color"/>
			</td>
		</tr>
		<tr class="address2" style="display:none;">
			...
			<td>
				...
				<form:errors element="div" path="space_address2" cssClass="error-color"/>
			</td>
		</tr>
		<tr>
			<td>대표이미지</td>
			<td class="image">
				<ul>
					<li>
						...
						<form:errors element="div" path="space_photo1" cssClass="error-color"/>
					</li>
				</ul>
			</td>
		</tr>
		...
		<tr>
			<td>상세설명</td>
			<td><form:textarea path="space_content"/></td>
			<form:errors element="div" path="space_content" cssClass="error-color"/>
			<script>
