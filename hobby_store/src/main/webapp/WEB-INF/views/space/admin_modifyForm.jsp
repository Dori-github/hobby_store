	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<form:form modelAttribute="spaceVO" name="update_form"
					id="update_form" enctype="multipart/form-data"
					action="admin_modify.do">
				...
				<form:errors path="space_limit" 
					...
					<img src="imageView.do?space_num=${spaceVO.space_num}&space_type=1" width="70" height="70" id="photo1" class="space-space_photo">
				    ...
				    <form:errors path="space_photo2" cssClass="error-color"/>     
							...
							<tr>
								...
								<td width="80%">
								<div class="upload-space">
					<img src="imageView.do?space_num=${spaceVO.space_num}&space_type=4" width="70" height="70" id="photo3" class="space-space_photo3">
