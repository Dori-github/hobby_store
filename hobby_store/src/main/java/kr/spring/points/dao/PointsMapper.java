...
public interface PointsMapper {
	...
	/* 포인트 적립 시 소멸 일자를 1년 1일 후로 계산해서 넣기. 형식 Date로 수정? */
	...
	public void savedPoints(PointsVO points);	
	@Insert("INSERT INTO points (points_num, points_type, used_points, used_date, mem_num) VALUES (points_seq.nextval, 1, #{used_points}, #{used_date}, #{mem_num})")
